...
const DreamInterpretationFormView: React.FC<DreamInterpretationFormViewProps> = ({ setDreamData, navigate }) => {
    ...
    return (
        <div className="max-w-3xl mx-auto animate-fade-in">
            ...
            >
                <h1 className="font-serif text-4xl font-bold text-primary mb-2 text-center">Interpretación de Sueños</h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        <label htmlFor="dream" className="block text-base font-medium text-text-secondary mb-2">Tu Sueño</label>
                        <textarea
                            id="dream"
                            rows={10}
                            value={dream}
