...
const AstralChartFormView: React.FC<AstralChartFormViewProps> = ({ setAstralChartData, navigate }) => {
    ...
    return (
        <div className="max-w-2xl mx-auto animate-fade-in">
            ...
            >
                <h1 className="font-serif text-4xl font-bold text-primary mb-2 text-center">Crea tu Carta Astral</h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        <label htmlFor="name" className="block text-base font-medium text-text-secondary mb-2">Nombre Completo</label>
                    ...
                    <div>
                        <label htmlFor="email" className="block text-base font-medium text-text-secondary mb-2">Correo Electrónico</label>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label htmlFor="birthTime" className="block text-base font-medium text-text-secondary mb-2">Hora de Nacimiento</label>
                    ...
                    <div>
                        <label htmlFor="birthPlace" className="block text-base font-medium text-text-secondary mb-2">Lugar de Nacimiento</label>
