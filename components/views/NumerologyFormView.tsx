...
const NumerologyFormView: React.FC<NumerologyFormViewProps> = ({ setNumerologyData, navigate }) => {
    ...
    return (
        <div className="max-w-2xl mx-auto animate-fade-in">
            ...
            >
                <h1 className="text-4xl font-bold text-primary mb-2 text-center">Tu Perfil Numerológico</h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        <label htmlFor="fullName" className="block text-sm font-medium text-text-secondary mb-2">Nombre Completo</label>
                    ...
                    <div>
                     ...
                     <div>
                        <label htmlFor="email" className="block text-sm font-medium text-text-secondary mb-2">Correo Electrónico (Opcional)</label>
