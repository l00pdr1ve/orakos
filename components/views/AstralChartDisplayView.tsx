...
const LoadingSpinner: React.FC = () => (
    <div className="flex flex-col items-center justify-center gap-4 text-center">
        ...
        <h2 className="font-serif text-2xl font-bold text-text-secondary animate-pulse">Consultando los astros...</h2>
        ...
        if (error) {
            return (
                <div className="text-center text-red-800 bg-red-100 border border-red-300 p-8 rounded-lg">
                    <h2 className="font-serif text-2xl font-bold text-red-800 mb-2">Error al generar la carta</h2>
                    <p>{error}</p>
                </div>
            )
        }
        ...
        return (
            <>
                <div className="bg-secondary/10 border border-secondary/20 text-center p-4 rounded-lg mb-6">
                    <p className="font-semibold text-secondary">¡Tu carta astral está lista!</p>
                </div>
