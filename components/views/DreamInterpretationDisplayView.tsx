...
const LoadingSpinner: React.FC = () => (
    <div className="flex flex-col items-center justify-center gap-4 text-center">
        ...
        <h2 className="font-serif text-2xl font-bold text-text-secondary animate-pulse">Descifrando tu subconsciente...</h2>
        ...
        if (error) {
            return (
                <div className="text-center text-red-800 bg-red-100 border border-red-300 p-8 rounded-lg">
                    <h2 className="font-serif text-2xl font-bold text-red-800 mb-2">Error al generar la interpretación</h2>
                    <p>{error}</p>
                </div>
            )
        }
